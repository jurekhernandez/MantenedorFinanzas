    ...
    <div class="row">
        <div class="offset-9 col-3">
            <button type="button" class="btn btn-rounded  btn-outline-primary mb-3 " data-toggle="modal"
                data-target=".bd-example-modal-sm">Registrar Egreso
            </button>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Listado de egresos</h4>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Registro de Egresos</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span>&times;</span>
                </button>
            </div>
            {!! Form::open(['url' => 'registrarEgreso' , 'method' => 'post']) !!}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    {{ Form::label("fecha_egreso", 'Fecha Egreso', ['class' => 'col-form-label']) }}
                                    {!! Form::date('fecha_egreso',\Carbon\Carbon::now(),['class' =>
                                    'form-control' ] ) !!}
                                    <div id="error_fecha_egreso" class="alert"> </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" type="button" id="registrarEgreso">Registrar</button>
...
<script src="{{ asset('js/finanzas/egreso.js') }}"></script>
@endsection